  ...
  return (
    <div>
        <nav className="fixed left-0 right-0 z-50 lg:top-4">
            {/* Desktop Menu */}
            <div className="mx-auto hidden max-w-xl items-center justify-center
                    ...
                    <div>
                        <ul className="flex items-center gap-4">
                            {NAVIGATION_LINKS.map((item, index) => (
                                <li key={index}>
                                    <a href={item.href} className="text-sm hover:text-stone-300" onClick={(e) => handleLinkClick(e, item.href)}>
                                        {item.label}
                                    </a>
                                </li>
                            ))}
            ...
            <div className="py-2 backdrop-blur-md lg:hidden">
                <div className="flex items-center justify-between">
                    <div>
                        <a href="#">
                            <span className="pl-20 uppercase">David Stones</span>
                        </a>
                    </div>
