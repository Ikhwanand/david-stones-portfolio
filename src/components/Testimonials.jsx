...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" ref={testimonialsRef} className="py-16">
        <h2 className="mb-8 text-center text-3xl font-medium lg:text-4xl">
            Testimonial
        </h2>
        <div className="px-4">
            <div className="flex flex-col items-center text-center">
                <img src={TESTIMONIAL.image} alt={TESTIMONIAL.name} className="testimonial-image mb-6 h-24 w-24 rounded-full
